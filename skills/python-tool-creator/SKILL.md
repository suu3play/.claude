---
name: python-tool-creator
description: 社内用Pythonツール作成を支援するスキル。「Pythonツールを作成」「社内用Pythonツール」「ChatGPT+Slackツール」「勤怠データ取得ツール」等の依頼で起動。ChatGPT/Slack/Teams/従業員情報/勤怠情報の5種類のベーステンプレートを提供
---
...
以下のキーワードでPythonツール作成を依頼された時に起動:
- 「Pythonツールを作成」「社内用Pythonツール作成」
- 「ChatGPTで分析してSlackに通知するツール」
